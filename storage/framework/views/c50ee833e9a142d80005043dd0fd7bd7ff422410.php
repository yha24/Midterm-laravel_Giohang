                        ...
                        <div class="beta-dropdown cart-body">
                            ...
                            <div class="cart-item" id="cart-item<?php echo e($products['item']['id']); ?>">
                                <a class="cart-item-delete"
                                    href="del-cart/<?php echo e($products['item']['id']); ?>"
                                    value="<?php echo e($products['item']['id']); ?>"
                                    soluong="<?php echo e($products['qty']); ?>"><i class="fa fa-times"></i></a>
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <span
                                            class="cart-item-title"><?php echo e($products['item']['name']); ?></span>
                                        <span
                ...
                <ul class="l-inline ov">
                    ...
                    <li><a href="#">Loại sản phẩm</a>
                        <ul class="sub-menu">
                            ...
                            <li><a href="<?php echo e(url('/loaisanpham', $loai->id)); ?>"><?php echo e($loai->name); ?></a>
                            </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    </li>
...
</div> <!-- #header --><?php /**PATH D:\laravel_Wishlist-main\resources\views/header.blade.php ENDPATH**/ ?>