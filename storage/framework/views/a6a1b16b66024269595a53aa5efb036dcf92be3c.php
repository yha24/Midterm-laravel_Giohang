            ...
            <table class="table">
                ...
                <tbody>
                    <?php $__currentLoopData = $product_id; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $products): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td>
                                <a class="pull-left" href="#"><img src="source/image/product/<?php echo e($products['item']['image']); ?>" alt="" width="100px" height="100px"></a>
                            </td>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Tra\Laravel\resources\views/page/Wishlist.blade.php ENDPATH**/ ?>