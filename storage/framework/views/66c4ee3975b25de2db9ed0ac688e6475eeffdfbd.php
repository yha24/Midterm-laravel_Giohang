                                        ...
                                        <div class="single-item">
                                            ...
                                            <div cflass="single-item-caption">
                                                <a class="add-to-cart pull-left"
                                                    href="<?php echo e(route('themgiohang', $new->id)); ?>">
                                                    <i class="fa fa-shopping-cart"></i></a>
                                                <a class="beta-btn primary" href="detail/<?php echo e($new->id); ?>">Details 
                                                    <i class="fa fa-chevron-right"></i></a>
                                                <a class="beta-btn primary" href="<?php echo e(route('WishListShow', $new->id)); ?>">
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Tra\Laravel\resources\views/page/trangchu.blade.php ENDPATH**/ ?>