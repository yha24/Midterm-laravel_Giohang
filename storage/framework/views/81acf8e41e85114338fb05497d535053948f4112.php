        ...
        <div class="container">
            ...
            <div class="pull-right auto-width-right">
                <ul class="top-details menu-beta l-inline">
                    ...
                    <li><a href="logout"><ion-icon name="log-out-outline"></ion-icon><?php echo e(Session('user')->name); ?></a></li>
                    <?php else: ?>
        ...
        <div class="container beta-relative">
            ...
            <div class="pull-right beta-components space-left ov">
                ...
                <?php if(Session::has('cart')): ?>						
					<div class="cart">					
						<div class="beta-select"><i class="fa fa-shopping-cart"></i> Giỏ hàng (<?php if(Session::has('cart')): ?><?php echo e(Session('cart')->totalQty); ?><?php else: ?> Trong <?php endif; ?>) <i class="fa fa-chevron-down"></i></div>				
						<div class="beta-dropdown cart-body">				
							...
							<div class="cart-item" id="cart-item<?php echo e($products['item']['id']); ?>">			
								<a class="cart-item-delete" href="del-cart/<?php echo e($products['item']['id']); ?>" value="<?php echo e($products['item']['id']); ?>" soluong="<?php echo e($products['qty']); ?>"><i class="fa fa-times"></i></a>		
								<div class="media">		
									<a class="pull-left" href="#"><img src="source/image/product/<?php echo e($products['item']['image']); ?>" alt=""></a>	
									<div class="media-body">	
										<span class="cart-item-title"><?php echo e($products['item']['name']); ?></span>
										<span class="cart-item-amount"><?php echo e($products['item']['qty']); ?>*<span><?php echo e($products['item']['unit_price']); ?></span></span>
									</div>	
								</div>		
							</div>			
							...
							<div class="cart-total text-right">Tổng tiền: <span class="cart-total-value"><?php echo e(number_format(Session('cart')->totalPrice)); ?> đồng</span></div>		
								<div class="clearfix"></div>		
...
</div> <!-- #header --><?php /**PATH C:\xampp\htdocs\LearnLaravel\WebsiteLaravel\resources\views/header.blade.php ENDPATH**/ ?>