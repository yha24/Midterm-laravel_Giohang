...
Route::get('/Wishlist/{id}', [WishListController::class, 'getAddToWishlist'])->name('WishListShow');   //name('WishListShow') --> đặt tên cho routeoute::get('/Wishlist-count/{id}', [WishListController::class, 'WishListShowCount'])->name('WishListShowCount');